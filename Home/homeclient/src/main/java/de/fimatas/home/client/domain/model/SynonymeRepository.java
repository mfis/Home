...
public class SynonymeRepository {
    ...
    static {
        ...
        SYNONYMES.add(new Synonym<Type>("Temperatur|warm|kalt|Wärme|Kälte|Grad|Wetter|Luftfeuchtigkeit", Type.THERMOMETER));
        ...
        SYNONYMES.add(new Synonym<Type>("Rollade|Rollladen|Rollo|Rollos (links|linke|linken|linkes)", Type.SHUTTER_LEFT));
        SYNONYMES.add(new Synonym<Type>("Rollade|Rollladen|Rollo|Rollos (rechts|rechte|rechtes|rechten)", Type.SHUTTER_RIGHT));
        ...
        SYNONYMES.add(new Synonym<Type>(
            "Thermometer|Temperatur|warm|kalt|Wärme|Kälte|Grad|Wetter|sonnig|Sonne|Luftfeuchtigkeit", Type.SYSVAR_THERMOMETER));
