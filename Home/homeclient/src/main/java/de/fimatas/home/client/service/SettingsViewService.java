...
public class SettingsViewService {
    ...
    public void fillSettings(Model model, SettingsModel settingsModel) {
        ...
        switchPushHints.setLink(HouseViewService.MESSAGEPATH + TYPE_IS + MessageType.SETTINGS_PUSH_HINTS + AND_VALUE_IS
            + !settingsModel.isPushHints());
        ...
        switchPushHintsHysteresis.setState(settingsModel.isHintsHysteresis() ? EINGESCHALTET : AUSGESCHALTET);
        ...
        switchPushHintsHysteresis.setLink(HouseViewService.MESSAGEPATH + TYPE_IS + MessageType.SETTINGS_PUSH_HINTS_HYSTERESIS
        ...
        switchPushDoorbell.setLink(HouseViewService.MESSAGEPATH + TYPE_IS + MessageType.SETTINGS_PUSH_DOORBELL + AND_VALUE_IS
            + !settingsModel.isPushDoorbell());
