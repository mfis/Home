...
public enum Device {
    ...
    WARMTH_POWER_PRODUCTION_COUNTER_HEATPUMP_BASEMENT(HomematicProtocol.SYSVAR, Type.SYSVAR_WARMTH_POWER_PRODUCTION_COUNTER_HEATPUMP_BASEMENT, Place.BASEMENT, true, Datapoint.LIST_SYSVAR, null), //
