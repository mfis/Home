...
public enum Device {
	...
	THERMOMETER_WASCHKUECHE(Protocol.HMIP, "000E9A498BA811", 1, Type.THERMOMETER, Place.LAUNDRY, true), //
	...
	HAUSTUER_KLINGEL_HISTORIE(Protocol.SYSVAR, "3218", null, Type.DOORBELL_TIMESTAMP_HISTORY, Place.FRONTDOOR,
			false), //
	HAUSTUER_KAMERA(Protocol.HM, "PEQ0508418", 1, Type.SWITCH_FRONTDOOR_CAMERA, Place.FRONTDOOR, false), //
	// @formatter:on
	;
