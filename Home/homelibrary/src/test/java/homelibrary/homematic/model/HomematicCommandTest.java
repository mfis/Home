...
public class HomematicCommandTest {
	...
	public void testBuildCommandReadDeviceDatapointSysVar() throws Exception {
		assertThat(HomematicCommand.read(Device.AUSSENTEMPERATUR, Datapoint.SYSVAR_DUMMY).buildCommand(), is(
				"var VAR_CONCLUSIONTEMPERATUREDRAUSSEN = dom.GetObject('ConclusionTemperatureDraussen').Value();"));
	}
	...
	public void testBuildCommandWriteDeviceDatapointStringSysVar() throws Exception {
		assertThat(
				HomematicCommand.write(Device.AUSSENTEMPERATUR, Datapoint.SYSVAR_DUMMY, "NEWVALUE")
						.buildCommand(),
