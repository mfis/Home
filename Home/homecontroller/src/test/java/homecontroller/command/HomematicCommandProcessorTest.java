...
public class HomematicCommandProcessorTest {
	...
	public void testBuildCommandReadDeviceDatapointSysVar() throws Exception {
		assertThat(
				processor.buildCommand(homematicCommandBuilder.read(Device.AUSSENTEMPERATUR, Datapoint.SYSVAR_DUMMY)),
	...
	public void testBuildCommandWriteDeviceDatapointString() throws Exception {
		assertThat(
				processor.buildCommand(homematicCommandBuilder.write(Device.STROMZAEHLER, Datapoint.POWER, "NEWVALUE")),
	...
	public void testBuildCommandWriteDeviceDatapointStringSysVar() throws Exception {
		assertThat(
				processor.buildCommand(
						homematicCommandBuilder.write(Device.AUSSENTEMPERATUR, Datapoint.SYSVAR_DUMMY, "NEWVALUE")),
