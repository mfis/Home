...
public class PushServiceTest {
    ...
    public void testFormatMessagesAllNew() {
        ...
        newModel.getClimateBathRoom().getHints().overtakeOldHints(oldModel.getClimateBathRoom().getHints(), dateTimeNew);
        newModel.getClimateLivingRoom().getHints().overtakeOldHints(oldModel.getClimateLivingRoom().getHints(), dateTimeNew);
