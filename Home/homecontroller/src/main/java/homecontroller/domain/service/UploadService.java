...
public class UploadService {
	...
	private void scheduled() {
		...
		cameraModel.getLivePictures().put(Device.HAUSTUER_KAMERA, cameraPicture);

		uploadBinary("http://localhost:8099/uploadCameraModel", cameraModel);
	}

	private void uploadBinary(String url, CameraModel cameraModel) {
		...
		HttpEntity<CameraModel> request = new HttpEntity<>(cameraModel, headers);
