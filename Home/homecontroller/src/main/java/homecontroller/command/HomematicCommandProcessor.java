package homecontroller.command;

import static homecontroller.command.HomematicCommandConstants.BRACKET_CLOSE;
import static homecontroller.command.HomematicCommandConstants.BRACKET_OPEN;
import static homecontroller.command.HomematicCommandConstants.EMPTY;
import static homecontroller.command.HomematicCommandConstants.EQUAL;
import static homecontroller.command.HomematicCommandConstants.E_O_F;
import static homecontroller.command.HomematicCommandConstants.POINT;
import static homecontroller.command.HomematicCommandConstants.QUOTE;
import static homecontroller.command.HomematicCommandConstants.SEMICOLON;
import static homecontroller.command.HomematicCommandConstants.VAR;
...
import homelibrary.homematic.model.HomematicProtocol;
...
public class HomematicCommandProcessor {
	...
	private String datapointAdress(HomematicCommand command) {
		...
		sb.append(":");
		sb.append(command.getDatapoint().getFixedChannel() == null
				? deviceQualifier.channelFrom(command.getDevice()).toString()
