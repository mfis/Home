...
import static homecontroller.command.HomematicCommandConstants.DATAPOINT_METHOD;
import static homecontroller.command.HomematicCommandConstants.DOM_METHOD;
import static homecontroller.command.HomematicCommandConstants.EMPTY;
import static homecontroller.command.HomematicCommandConstants.LAST_TIMESTAMP;
...
import static homecontroller.command.HomematicCommandConstants.PROGRAM_EXECUTE;
import static homecontroller.command.HomematicCommandConstants.STATE;
import static homecontroller.command.HomematicCommandConstants.SUFFIX_TS;
import static homecontroller.command.HomematicCommandConstants.VALUE;
